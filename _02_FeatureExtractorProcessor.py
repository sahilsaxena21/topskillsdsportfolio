...
class Feature_Extractor_and_Processor:
    ...
    def _initialize_stopwords(self):    
        ...
        stop.add('provide'); stop.add('within'); stop.add('years experience'); stop.add('performance'); 
        stop.add('go'); stop.add('training'); stop.add('flex'); stop.add('k'); stop.add('f')
        return stop
    ...
    def get_subset_counter_list_old(self):
        ...
        counter_subset_single = self._do_subset(counter_single, self.features_list_single)
        counter_subset_phrase = self._do_subset(counter_phrase, self.features_list_phrase)
        ...
        self.topk_single = list(counter_subset_single.items())
        self.topk_phrase = list(counter_subset_phrase.items())
...
#         self.get_subset_counter_list()
    ...
    def _execute_post_processing(self):
        ...
        #initialize the df_tools df used for all analysis
        ...
        #initiate top_tools_dict        
        #top technical terms used in job postings
        top_tools_dict = {}
